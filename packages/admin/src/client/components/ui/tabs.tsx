...
const tabsListVariants = cva(
	"qa-tabs__list group/tabs-list text-muted-foreground inline-flex w-fit items-center justify-center p-[3px] group-data-horizontal/tabs:h-8 group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col",
	{
		variants: {
			variant: {
				default: "bg-muted",
