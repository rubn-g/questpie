...
For stage configuration, transition access rules, hooks, stage reads, and scheduled transitions, see [Versioning & Workflow](/docs/backend/data-modeling/versioning-workflow).
...
- [Versioning & Workflow](/docs/backend/data-modeling/versioning-workflow) — Configure draft and publishing stages
