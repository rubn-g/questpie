...
function DrawerOverlay({
	...
	return (
		<DrawerPrimitive.Overlay
			...
			className={cn(
				"qa-drawer__overlay data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 fixed inset-0 z-50 bg-black/80",
				className,
			)}
			{...props}
		/>
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn(
				"qa-drawer__header flex flex-col gap-1 pt-4 group-data-[vaul-drawer-direction=bottom]/drawer-content:text-center group-data-[vaul-drawer-direction=top]/drawer-content:text-center md:text-left",
				className,
			)}
			{...props}
		/>
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn(
				"qa-drawer__footer mt-auto flex flex-col gap-2 py-4",
				className,
			)}
			{...props}
		/>
