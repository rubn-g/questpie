...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props) {
	return (
		<SheetPrimitive.Title
			...
			className={cn(
				"qa-sheet__title text-foreground font-mono text-sm font-medium",
				className,
			)}
			{...props}
		/>
