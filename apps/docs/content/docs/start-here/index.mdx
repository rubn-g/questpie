...
3. **Type exports** — `AppConfig`, `AppCollections`, `AppFunctions` for end-to-end type safety
...
- Type-safe `app` instance with all collections, functions, jobs, services
...
| Business logic alongside data | Functions, hooks, jobs — all in the same project with DI |
