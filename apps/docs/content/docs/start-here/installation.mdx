...
This scans your file convention directories, discovers collections/functions/jobs, and generates:
...
Re-run codegen to pick up admin conventions (sidebar, dashboard, branding):
