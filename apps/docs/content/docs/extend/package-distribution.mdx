...
{
  "changelog": ["@changesets/changelog-github", { "repo": "questpie/questpie" }],
  "commit": false,
  "fixed": [
    ["questpie", "@questpie/admin", "@questpie/elysia", "@questpie/hono",
     "@questpie/next", "@questpie/tanstack-query"]
  ],
  "access": "public",
  "baseBranch": "main",
...
```json title="tsconfig.json"
{
  ...
  "include": [
    "src",
    "src/server/modules/**/.generated/*.ts"
  ]
}
```
